...
public class OneToManyDemo {
    public static void main(String[] args) {
        ...
        float total = 0;
        Employee highestPaid = dept.emplst.get(0); // assume first is highest
        ...
        System.out.println("Highest-paid Employee: " + highestPaid.name + " with salary " + highestPaid.salary);
    }
}
